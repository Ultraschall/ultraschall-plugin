...
// I_MCPX : int * : current MCP position X (relative to mixer container)
// I_MCPY : int * : current MCP position Y (relative to mixer container)
// I_MCPW : int * : current MCP width
// I_MCPH : int * : current MCP height
...
// I_PLAY_OFFSET_FLAG : int * : track playback offset state (&1=bypassed, &2=offset value measured in samples, otherwise seconds)
// D_PLAY_OFFSET : double * : track playback offset
